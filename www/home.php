      ...
      <div class="col-md-6 probootstrap-animate" data-animate-effect="fadeInRight">
        ...
        <figure>
          <div class="probootstrap-video">
            ...
            <img src="<? echo _PROJECT_URL_ ?>/view/img/slider_2.jpg" alt="Free HTML5 Bootstrap Template by uicookies.com"
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4 probootstrap-animate">
        <div class="probootstrap-card">
          <div class="probootstrap-card-media">
            <a href="single-page.html"><img src="<? echo _PROJECT_URL_ ?>/view/img/slider_1.jpg" class="img-responsive img-border"
      ...
      <div class="col-md-4 probootstrap-animate">
        <div class="probootstrap-card">
          <div class="probootstrap-card-media">
            <a href="single-page.html"><img src="<? echo _PROJECT_URL_ ?>/view/img/slider_2.jpg" class="img-responsive img-border"
                alt="Free HTML5 Template by uicookies.com"></a>
          </div>
          <div class="probootstrap-card-text">
      ...
      <div class="col-md-4 probootstrap-animate">
        <div class="probootstrap-card">
          <div class="probootstrap-card-media">
            <a href="single-page.html"><img src="<? echo _PROJECT_URL_ ?>/view/img/slider_3.jpg" class="img-responsive img-border"
                alt="Free HTML5 Template by uicookies.com"></a>
          </div>
          <div class="probootstrap-card-text">
